...
<link rel="stylesheet" href="./css/_updateusers.css">
<script type="text/javascript" src="./js/_updateValid.js"></script>
</head>
<body>
<jsp:include page="/WEB-INF/pages/_navbar.jsp"></jsp:include>
	<article class="card-body mx-auto" style="max-width: 400px;">
	<h4 class="card-title mt-3 text-center">Update Account</h4>
	<p class="text-center">Please fill in the field complete</p>	
	<form method="post" action="_usersUpdate" id="registForm">
		<table>
			<!-- form group userName -->
			<tr>
				<td>
			...
			<tr>
				<td>
					<div class="form-group input-group">
						...
						<input class="form-control" placeholder="Change password" name="loginPass" id="loginPass" type="password"/>						
					</div>					
				</td>
				<!--  <td>
					<div>
					...
					<div class="form-group input-group">
						...
						<div class="wrapper">
						  <div class="toggle_radio">
							<input type="radio" checked="checked" class="toggle_option" id="female" name="sex" value="female">
							<input type="radio" class="toggle_option" id="man" name="sex" value="man">
			...
			<tr>
				<td>
					<div class="form-group input-group">
						...
						<input class="form-control" placeholder="Birthday" name="birthday" id="birthday" type="text">
					</div>
				</td>
				<td class="tdError"><label class="errorClass" id="birthdayError"></label>
				</td>
			</tr>
			<!-- form group address -->
			<tr>
				<td>
					<div class="form-group input-group">
						...
						<input class="form-control" placeholder="Address" name="address" id="address" type="text">
					</div>
				</td>
				<td class="tdError"><label class="errorClass" id="addressError"></label>
				</td>
			</tr>
			<!-- form group GCD code -->
			<tr>
